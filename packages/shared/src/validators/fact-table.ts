...
const postFactTableBody = z
  .object({
    ...
    managedBy: z
      .enum(["", "api", "admin"])
      .describe('Set this to "api" to disable editing in the Flagify UI')
      .optional(),
  })
  .strict();
...
const postFactTableFilterBody = z
  .object({
    ...
    managedBy: z
      .enum(["", "api"])
      .describe(
        'Set this to "api" to disable editing in the Flagify UI. Before you do this, the Fact Table itself must also be marked as "api"',
      )
      .optional(),
  })
  .strict();
