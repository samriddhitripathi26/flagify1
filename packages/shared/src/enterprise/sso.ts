...
function getSSOConfig() {
  ...
  // Sanity check for Flagify Cloud (to avoid misconfigurations).
  ...
  if (
    ...
    !isLocalhost &&
    config?.metadata?.issuer !== "https://flagify.auth0.com/"
  ) {
    throw new Error("Invalid SSO configuration for Flagify Cloud");
  }
