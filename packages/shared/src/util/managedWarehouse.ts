...
export const MANAGED_WAREHOUSE_SENDING_EVENTS_DOC_URL =
  "https://docs.flagify.io/app/managed-warehouse#sending-events";
...
/**
 * Managed Warehouse is backed by the flagify_clickhouse datasource type.
 * Because Flagify owns the warehouse compute, we enable query optimizations
...
export function isManagedWarehouse(
  ...
  return datasource.type === "flagify_clickhouse";
}
