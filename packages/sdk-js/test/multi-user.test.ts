...
import { FlagifyClient } from "../src/FlagifyClient";
...
describe("FlagifyClient", () => {
  ...
  describe("Merges user and global context fields", () => {
    ...
    it("Merges enabled flag", () => {
      const gb = new FlagifyClient().initSync({ payload: {} });
      const gbDisabled = new FlagifyClient({
        enabled: false,
      }).initSync({ payload: {} });
    ...
    it("Merges forcedVariations", () => {
      const gb = new FlagifyClient().initSync({ payload: {} });
      const gbForced = new FlagifyClient({
    ...
    it("Merges globalAttributes and attributes", () => {
      const gb = new FlagifyClient().initSync({
        payload: {
          features: {
            feature: {
              defaultValue: false,
