...
import { FlagifyClient, UserScopedFlagify } from "../FlagifyClient";
...
export function devtoolsPlugin(devtoolsState?: DevtoolsState): Plugin {
  return (gb: Flagify | UserScopedFlagify | FlagifyClient) => {
    // Only works for user-scoped Flagify instances
 ...
 * @param gb - Flagify instance. DevMode must be enabled to view log events.
...
export function getDebugEvent(
  ...
  } else if (gb instanceof UserScopedFlagify) {
    // UserScopedFlagify SDK
