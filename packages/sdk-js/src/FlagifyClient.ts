...
> {
  ...
  public initSync(options: InitSyncOptions): FlagifyClient<AppFeatures> {
  ...
  public createScopedInstance(
    ...
    return new UserScopedFlagify(this, userContext, [
...
export class UserScopedFlagify<
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  AppFeatures extends Record<string, any> = Record<string, any>,
> {
  private _gb: FlagifyClient;
  private _userContext: UserContext;
  public logs: Array<LogUnion>;

  constructor(
    gb: FlagifyClient<AppFeatures>,
    userContext: UserContext,
    plugins?: Plugin[],
  ) {
    this._gb = gb;
