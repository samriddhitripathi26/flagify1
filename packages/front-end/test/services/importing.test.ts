  ...
  describe("transformLDFeatureFlagToGBEnvironment", () => {
    ...
    it("should transform complex feature with multiple rules, targets, and prerequisites", () => {
                    ...
                    },
                    {
                      ...
                      clauses: [
                        ...
                        },
                        {
                          ...
                          attribute: "email",
                          op: "in",
                          values: ["abc@flagify.io", "def@flagify.io"],
                          contextKind: "user",
                          negate: false,
                        },
                      ],
      ...
      const ruleIds0 = result?.[0]?.rules
        ?.filter((r) => r.environments?.includes("production"))
        ?.map((r) => r.id);
      ...
      >[] = [
        {
          ...
          project: "prj_xyz987",
          description: "",
          owner: "Growth Book (hello@flagify.io)",
          defaultValue: "1",
          environmentSettings: {
            production: {
              enabled: true,
            ...
            },
            {
              ...
              condition: JSON.stringify({
                $and: [
                  ...
                  {
                    email: {
                      $in: ["abc@flagify.io", "def@flagify.io"],
                    },
                  },
                ],
              }),
