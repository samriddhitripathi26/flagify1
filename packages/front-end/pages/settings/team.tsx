        ...
        <TabsContent value="teams">
          <>
            ...
            {hasTeamsFeature ? (
              ...
              <PremiumEmptyState
                title="Teams"
                description="Create groups of Flagify users to organize and manage permissions centrally"
                commercialFeature="teams"
                learnMoreLink="https://docs.flagify.io/account/user-permissions#teams"
              />
            )}
          </>
        </TabsContent>
          ...
          <>
            ...
            {hasCustomRolesFeature ? (
              ...
              <PremiumEmptyState
                ...
                learnMoreLink="https://docs.flagify.io/account/user-permissions#custom-roles"
              />
            )}
          </>
        </TabsContent>
