          ...
          <div className="appbox p-4">
            <div className="row">
              ...
              <div className="col">
                <NextLink
                  ...
                  onClick={() =>
                    setStep({
                      step: "Integrate the Flagify SDK into your app",
                ...
                >
                  Integrate the Flagify SDK into your app
                </NextLink>
                <Box mt="2">Allow Flagify to communicate with your app.</Box>
            ...
            <div className="row">
              ...
              <div className="col">
                ...
                <Box mt="2">
                  Allow Flagify to query your warehouse to compute traffic
