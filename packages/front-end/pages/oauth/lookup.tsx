...
export async function lookupByEmail(email: string) {
  if (!isCloud()) {
    throw new Error("Only available on Flagify Cloud");
  }
...
export default function OAuthLookup() {
  ...
  const leftside = (
    <>
      <h1 className="title h1">Flagify Enterprise</h1>
      <p></p>
    </>
  );
  return (
    ...
    >
      ...
      <div className="text-center mt-3">
        ...
        <div>
          <br />
          Don&apos;t have a Flagify Enterprise plan yet?
          <br />
          Email <a href="mailto:sales@flagify.io">sales@flagify.io</a> to
