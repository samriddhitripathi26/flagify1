...
export default function AccountPlanNotices() {
  ...
  const usageTooltipBody = permissionsUtil.canViewUsage() ? (
    ...
    <Box className={styles["notice-tooltip"]}>
      ...
      <a
        href="https://docs.flagify.io/faq#what-are-the-flagify-cloud-cdn-usage-limits"
  ...
  const managedWarehouseUsageTooltipBody = permissionsUtil.canViewUsage() ? (
    ...
    <Box className={styles["notice-tooltip"]}>
      Click to upgrade, or visit{" "}
      <a
        href="https://docs.flagify.io/app/managed-warehouse#limits"
        className="text-decoration-none"
        target="_blank"
        rel="noopener noreferrer"
        onClick={() => {
                  ...
                  <Tooltip
                    body={
                      license.plan === "enterprise" ? (
                        <>Contact sales@flagify.io to renew.</>
                      ) : (
                        <Box className={styles["notice-tooltip"]}>
              ...
              <Tooltip
                body={
                  <>
                    ...
                    sales@flagify.io for assistance.
                  </>
                }
              >
                <Box className={styles["error-notification"]}>
              ...
              <Tooltip
                body={
                  <>
                    ...
                    sales@flagify.io to resolve this issue.
                  </>
                }
              >
                <Box className={styles["error-notification"]}>
        ...
        default:
          return (
            <Flex gap={"3"} align="center">
              {usageMessage}
              <Tooltip
                body={<>Please contact support@flagify.io for assistance.</>}
              >
                <Box className={styles["error-notification"]}>
        ...
        if (license.plan === "enterprise") {
          return (
            <Tooltip
              body={
                <>
                  Contact sales@flagify.io if you need more time or would
                  like to upgrade
                </>
              }
            >
        ...
        <Tooltip
          body={
            <>
              ...
              sales@flagify.io to extend your quota.
            </>
          }
        >
          <Box className={styles["error-notification"]}>
