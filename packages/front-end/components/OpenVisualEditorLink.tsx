...
export const CHROME_EXTENSION_LINK =
  "https://chrome.google.com/webstore/detail/flagify-devtools/opemhndcehfgipokneipaafbglcecjia";
export const FIREFOX_EXTENSION_LINK =
  "https://addons.mozilla.org/en-US/firefox/addon/flagify-devtools/";
    ...
    <>
      ...
      {showExtensionDialog && (
        <Modal
          trackingEventModalType=""
          open
          header="Flagify DevTools Extension"
        ...
        >
          {["chrome", "firefox"].includes(browser) ? (
            <>
              You&apos;ll need to install the Flagify DevTools browser
