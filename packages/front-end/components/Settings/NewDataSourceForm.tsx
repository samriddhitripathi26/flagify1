...
const NewDataSourceForm: FC<{
  ...
  const showManagedWarehouse =
    isCloud() &&
    !datasources.some((d) => d.type === "flagify_clickhouse") &&
  ...
  if (step === "initial") {
    stepContents = (
      <div>
        <p className="mb-4">
          Flagify is <strong>Warehouse Native</strong>, which means we can
        ...
        <div>
          ...
          {showManagedWarehouse ? (
            <Callout status="info" mt="3" icon={null}>
              ...
              <Text mr="3">
                Flagify Cloud now offers a fully managed data warehouse
                option.
              </Text>
              <a
                href="#"
        ...
        {datasourceInfo ? (
          <Callout status="info" mb="3">
            ...
            <DocLink docSection={datasourceInfo.docs}>
              {datasourceInfo.display} to Flagify <FaExternalLinkAlt />
            </DocLink>{" "}
          </Callout>
        ) : null}
