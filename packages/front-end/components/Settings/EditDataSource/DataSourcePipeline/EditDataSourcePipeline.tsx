        ...
        <Flex direction="column" gap="6">
          <Flex direction="column" gap="3">
            <Text size="3" style={{ color: "var(--color-text-mid)" }}>
              Configure write permissions for Flagify in order to improve the
...
function ValidatePermissionsCheckbox({
  ...
  return (
    <Checkbox
      ...
      description="Verify that Flagify can write to your Data Source before exiting this modal"
      value={value}
      setValue={setValue}
    />
  );
  ...
  return (
    <Flex direction="column" gap="2">
      ...
      <Text size="3" style={{ color: "var(--color-text-mid)" }}>
        ...
        the default mode unchanged. Saving will validate that Flagify can
