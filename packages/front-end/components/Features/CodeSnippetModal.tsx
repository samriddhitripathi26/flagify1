...
import FlagifySetupCodeSnippet from "@/components/SyntaxHighlighting/Snippets/FlagifySetupCodeSnippet";
      ...
      >
        ...
        <div className="px-3">
          {language === "other" ? (
            ...
            <p>
              Below is some starter code to integrate Flagify into your app.
              Read the{" "}
                  ...
                  {language === "nextjs" && (
                    <div className="mb-3">
                      <p>
                        ...
                        Flagify adapter for Vercel&apos;s{" "}
                        <a
                          href="https://flags-sdk.dev/providers/flagify"
                          target="_blank"
                          rel="noreferrer"
                        >
                          Flags SDK
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  Flagify <strong>SDK Webhook</strong> to keep feature and
                  experiment values synced between Flagify and the web
                  server. This eliminates network requests from the web server
                  to Flagify.
                </li>
                <li>
                  Implement sticky bucketing using{" "}
                  <code>flagifyAdapter.setStickyBucketService()</code> for
                  advanced experimentation.
                </li>
                <li>
                  Expose Flagify data to Vercel&apos;s Flags Explorer by
