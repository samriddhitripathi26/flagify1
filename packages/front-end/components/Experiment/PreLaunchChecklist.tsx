...
export function getChecklistItems({
  ...
  items.push({
    ...
    display: (
      <>
        Integrate Flagify into your app by adding an SDK Connection{" "}
              ...
              description={
                item.hideDescription || item.status === "complete"
                  ...
                  : item.description !== undefined
                    ? item.description
                    : item.type === "auto"
                      ? "Flagify will mark this as completed automatically when you finish the task."
                      : "You must manually mark this as complete. Flagify is unable to detect this automatically."
              }
              error={item.warning}
              errorLevel="warning"
            />
