...
function getPrompts(data: { prompts: AIPromptInterface[] }): Array<{
  ...
  return [
    ...
    },
    {
      ...
      promptDescription:
        "Used by the product analytics explorer AI assistant. Flagify still provides datasource context, metrics and fact tables, exploration schema, and tool behavior automatically; the field below adds organization-specific guidance (tone, naming, policies, how to explain charts, etc.).",
      promptValue:
            ...
            <Flex align="start" direction="column" flexGrow="1" pt="6">
              <Flex align="start" gap="3" mb="6">
                ...
                <Flex direction="column">
                  ...
                  <Text>
                    Used to allow various AI features throughout Flagify.
                  </Text>
                </Flex>
              </Flex>
                            ...
                            {hasAnthropicKey() ? (
                              ...
                              <Box>
                                <Callout status="warning">
                                  ...
                                  our{" "}
                                  <a href="https://docs.flagify.io/self-host/env">
                                    self-hosting docs
                                  </a>
                                  .
                                </Callout>
              ...
              <Flex align="start" direction="column" flexGrow="1" pt="6">
                <>
                  <Box mb="6" width="100%">
                    <>
                      <p>
                        Flagify can use AI to analyze your experiments for
