          ...
          <Box mb="6" width="100%">
            <Box className="appbox p-3">
              ...
              <Checkbox
                ...
                description="Displays code references for feature flags in the Flagify UI"
                      ...
                      <Flex justify="between">
                        <Box>
                          ...
                          <Text as="p" mb="0">
                            ...
                            Flagify into your CI workflow.
                          </Text>
                        </Box>
                        <div className="col-sm-3 text-right">
                          <a
                            href="https://github.com/marketplace/actions/flagify-code-references"
                            target="_blank"
                            rel="noreferrer"
                          >
                      ...
                      <Flex justify="between">
                        <Box>
                          ...
                          <Text as="p" mb="0">
                            ...
                            our code references{" "}
                            <a
                              href="https://docs.flagify.io/api#tag/code-references"
                              target="_blank"
                              rel="noreferrer"
                            >
                              REST API endpoint
                        ...
                        <Box>
                          <Text wrap="nowrap">
                            <a
                              href="https://github.com/flagify/gb-find-code-refs"
                              target="_blank"
                              rel="noreferrer"
                            >
                              CLI Utility
                            ...
                            |{" "}
                            <a
                              href="https://hub.docker.com/r/flagify/gb-find-code-refs"
                              target="_blank"
                              rel="noreferrer"
                            >
                              Docker Image
