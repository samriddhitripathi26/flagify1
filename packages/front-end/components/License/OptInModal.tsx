    ...
    terms: (
      <>
        ...
        <Box mt="2">
          ...
          <a
            href="https://docs.flagify.io/integrations/ai"
            target="_blank"
            rel="noreferrer"
          >
            AI docs
          ...
          , review our{" "}
          <a
            href="https://www.flagify.io/legal/privacy-policy/06-19-2025"
            target="_blank"
            rel="noreferrer"
          >
            privacy notice
  ...
  "managed-warehouse": {
    ...
    terms: (
      <>
        ...
        Flagify and Clickhouse, and allowing us to store your event data
        passed to us.
        <a
          href="https://www.flagify.io/legal/privacy-policy/06-19-2025"
          target="_blank"
