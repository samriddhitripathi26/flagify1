...
export default function DataSourceDiagram({
  ...
  return (
    <div className={className}>
      <h3 className="mb-2">How A/B Test Analysis Works at Flagify</h3>
      <ol>
        <li>
        ...
        <li>
          Connect Flagify to your warehouse and define metrics using SQL
        </li>
        <li>
          Flagify queries your warehouse and uses a stats engine to analyze
          experiment results
        </li>
      </ol>
      Example:
