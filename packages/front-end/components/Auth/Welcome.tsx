...
export default function Welcome({
  ...
  const welcomeContent =
    state === "login" ? (
      ...
      <>
        <p>
          Getting started with Flagify only takes a few minutes. <br />
  ...
  const leftside = (
    <Flex direction="column" justify="between" height="100%" p="6">
      <Box>
        <a href="https://www.flagify.io" target="_blank" rel="noreferrer">
          <img
            src="/logo/flagify-logo-white.svg"
        ...
        >
          ...
          {state === "login" && (
            <Flex direction="column" mb="5" gap="2">
              ...
              <Text as="span" size="medium" weight="regular">
                Sign in to your Flagify account
              </Text>
            </Flex>
          )}
          {state === "forgot" && (
