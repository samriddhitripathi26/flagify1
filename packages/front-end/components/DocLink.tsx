...
const docSections = {
  ...
  flagify_clickhouse: "/app/managed-warehouse",
  //Language
  ...
  customMarkdown: "/using/flagify-best-practices#custom-markdown",
  customMetadata: "/using/flagify-best-practices#custom-fields",
  savedGroups: "/features/targeting#saved-groups",
  ga4BigQuery: "/guide/GA4-google-analytics",
  gtmSetup: "/guide/google-tag-manager-and-flagify",
  gtmCustomTracking:
    "/guide/google-tag-manager-and-flagify#4-tracking-via-datalayer-and-gtm",
...
const docSectionDisplayTitles: Partial<Record<DocSection, string>> = {
  flagify_clickhouse: "Managed Warehouse",
...
const docsOrigin = "https://docs.flagify.io";
