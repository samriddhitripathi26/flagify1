/**
 * Rows for Cmd+K: deep links into the Redoc REST API reference at docs.flagify.io/api.
 ...
 *
 * Re-verify after docs deploys: `curl -sL https://docs.flagify.io/api | grep -oE 'id="tag/[^"]+"'`
 */
const API_REFERENCE_BASE = "https://docs.flagify.io/api";
