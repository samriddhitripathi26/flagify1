          ...
          <div style={{ maxWidth: 900 }}>
                  ...
                  <GetStartedStep
                    ...
                    text={
                      <>
                        ...
                        or{" "}
                        <a
                          href="https://github.com/flagify/flagify/issues/new"
                          target="_blank"
                          rel="noreferrer"
                        >
                          open a GitHub issue
                  ...
                  <GetStartedStep
                    ...
                    text={
                      <p>
                        ...
                        With Flagify, you can build out an entire metric
            ...
            <div className="alert alert-info text-center">
              <p>
                ...
                experiment first to get a feel for the Flagify platform.
              </p>
                  ...
                  <GetStartedStep
                    ...
                    text={
                      <p>
                        ...
                        platform? Connect Flagify to your data warehouse and
