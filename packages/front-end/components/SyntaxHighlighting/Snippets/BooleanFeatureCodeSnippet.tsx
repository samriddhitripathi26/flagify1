  ...
  if (language.match(/^nocode/)) {
    return (
      <Code
        ...
        code={`
<script>
if (window._flagify?.isOn(${JSON.stringify(featureId)})) {
  ...
  if (language === "javascript") {
    return (
      <Code
        language="javascript"
        code={`
if (flagify.isOn(${JSON.stringify(featureId)})) {
  console.log("Feature is enabled!")
}
`.trim()}
      />
  ...
  if (language === "react") {
    return (
      <Code
        language="tsx"
        code={`
import { useFeatureIsOn } from "@flagify/flagify-react";
  ...
  if (language === "nodejs") {
    return (
      <Code
        ...
        code={`
app.get("/", (req, res) => {
  if (req.flagify.isOn(${JSON.stringify(featureId)})) {
...
export const myFeatureFlag = flag<boolean>({
  ...
  adapter: flagifyAdapter.feature<boolean>(),
  defaultValue: false,
  identify,
});
`.trim()}
