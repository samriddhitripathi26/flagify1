      ...
      <Callout status="info" mt="2" contentsAs="div">
        <Flex direction="column" gap="2" align="start">
          ...
          >
            ...
            >
              <Tooltip
                body="To identify tables, Flagify queries your Data Source to build an Information Schema, which tells us what databases, schemas, and tables are available to query."
                shouldDisplay={canRunQueries}
              >
                Identify Tables
              </Tooltip>
