...
/**
 * Flagify Slack context that should be appended to all messages
    ...
    elements: [
      {
        type: "image",
        image_url:
          "https://github.com/flagify/flagify/blob/main/packages/front-end/public/logo/Logo-mark.png?raw=true",
        alt_text: "Flagify logo",
      },
      {
        type: "plain_text",
