...
export async function postInvite(
  ...
  if (
    ...
    throw new Error(
      "Whoops! You've reached the seat limit on your license. Please contact sales@flagify.io to increase your seat limit.",
    );
  }
...
export async function getOrphanedUsers(req: AuthRequest, res: Response) {
  ...
  if (IS_CLOUD) {
    throw new Error("Unable to get orphaned users on Flagify Cloud");
  }
...
export async function addOrphanedUser(
  ...
  if (IS_CLOUD) {
    throw new Error("This action is not permitted on Flagify Cloud");
  }
...
export async function deleteOrphanedUser(
  ...
  if (IS_CLOUD) {
    throw new Error("Unable to delete orphaned users on Flagify Cloud");
  }
