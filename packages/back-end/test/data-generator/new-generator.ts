...
function viewHomepage(data: TableData, gb: Flagify, sim: SimulatorData) {
  // Land on home page
  trackPageView(
    {
      ...data,
...
function viewItemPage(data: TableData, gb: Flagify, sim: SimulatorData) {
...
function viewCheckout(data: TableData, gb: Flagify, sim: SimulatorData) {
  trackPageView(
    {
      ...data,
      path: `/checkout`,
